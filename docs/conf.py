...
project = 'molecool'
copyright = ("2020, Ivy Zhang. Project structure based on the "
...
texinfo_documents = [
    (master_doc, 'molecool', 'molecool Documentation',
     author, 'molecool', 'A Python package for analyzing and visualizing molecular structure. For MSF bootcamp.',
     'Miscellaneous'),
]
